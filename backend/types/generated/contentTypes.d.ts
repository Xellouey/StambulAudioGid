...
export interface ApiAppUserAppUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    platform: Schema.Attribute.Enumeration<['ios', 'android', 'rustore']>;
    publishedAt: Schema.Attribute.DateTime;
    purchasedTours: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    app_users: Schema.Attribute.Relation<
      ...
      'api::app-user.app-user'
    >;
    attributes: Schema.Attribute.Enumeration<['new', 'popular']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tour.tour'> &
      Schema.Attribute.Private;
    main_audio: Schema.Attribute.Media<
    ...
    >;
    name: Schema.Attribute.String;
    points_of_interests: Schema.Attribute.Relation<
      'oneToMany',
      'api::point-of-interest.point-of-interest'
    >;
